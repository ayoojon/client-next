...
export default function Index({ initalServices, pagination }: Props) {
  ...
  return (
    <div className="my-12 px-6 md:px-10 lg:px-14">
      <SEO siteTitle="Venue Services" />
      <h2 className="text-4xl font-semibold mb-6">Caterings</h2>
...
export const getStaticProps: GetStaticProps = async () => {
  try {
    const { data } = await Axios.get(`${server}/services?serviceType=caterings`);
