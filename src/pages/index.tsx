    ...
    <div className="container mx-auto px-6">
      ...
      <div className="py-14 min-h-screen flex flex-col-reverse md:flex-row md:items-center md:justify-between md:space-x-8">
        <div className="md:w-1/2">
          ...
          <p className="max-w-lg text-xl">
            ...
            elevated position with a stunning view. It{`&apos`}s the perfect place if you like nature. You can stay
          </p>
        </div>
      ...
      <div className="py-14 min-h-screen flex flex-col justify-center">
        ...
        <div className="lg:grid lg:grid-cols-3 lg:gap-8">
          ...
          <div className="lg:col-span-1 lg:flex lg:flex-col lg:justify-between">
            <p className="max-w-lg text-xl">
              Spend a unforgettable holiday in the enchanting surroundings of the town of Cistercians (reachable from
              the near airports of Bari and Brindisi). Trulls Edeka offers a heaven of peace and tranquillity, set in an
              elevated position with a stunning view. It
      ...
      <div className="py-14 min-h-screen flex flex-col justify-center">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="bg-yellow-400 px-8 lg:px-10 py-10 md:py-12 lg:col-span-1">
            ...
            <p className="text-lg">
              Spend a unforgettable holiday in the enchanting surroundings of the town of Cistercians (reachable from
              the near airports of Bari and Brindisi). Trulls Edeka offers a heaven of peace and tranquillity
            </p>
          </div>
          ...
          <div className="bg-indigo-600 px-8 lg:px-10 py-10 md:py-12 lg:col-span-2 text-white">
            ...
            <p className="text-lg">
              Spend a unforgettable holiday in the enchanting surroundings of the town of Cistercians (reachable from
              the near airports of Bari and Brindisi). Trulls Edeka offers a heaven of peace and tranquillity, set in
            </p>
          </div>
          <div
      ...
      <div className="py-14 min-h-screen flex flex-col justify-center">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="px-8 lg:px-10 py-10 md:py-12 lg:col-span-2" style={{ backgroundColor: '#ED7078' }}>
            <h2 className="max-w-64 text-3xl mb-4">Make your data easy to understand</h2>
            <p className="text-lg">
              Spend a unforgettable holiday in the enchanting surroundings of the town of Cistercians (reachable from
              the near airports of Bari and Brindisi). Trulls Edeka offers a heaven of peace and tranquillity, set in an
              elevated position with a stunning view. It
          ...
          <div className="bg-indigo-600 px-8 lg:px-10 py-10 md:py-12 lg:col-span-2 text-white">
            <h2 className="max-w-64 text-3xl mb-4">Create your own Custom Booking</h2>
            <p className="text-lg">
              Spend a unforgettable holiday in the enchanting surroundings of the town of Cistercians (reachable from
              the near airports of Bari and Brindisi). Trulls Edeka offers a heaven of peace and tranquillity, set in
            </p>
