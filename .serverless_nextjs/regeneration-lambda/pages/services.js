...
;// CONCATENATED MODULE: ./src/components/Cards/ServiceCard.tsx
...
;// CONCATENATED MODULE: ./src/components/services/FilterServices.tsx
        ...
        children: [/*#__PURE__*/jsx_runtime.jsx("div", {
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsxs)(node.FormControl, {
            ...
            children: [/*#__PURE__*/jsx_runtime.jsx(node.InputLabel, {
              ...
              name: "type",
              defaultValue: "" // value={searchQuery.serviceType}
              ,
              label: "type",
              onChange: service => setSearchQuery(_objectSpread(_objectSpread({}, searchQuery), {}, {
                serviceType: service.target.value
              })),
              children: [/*#__PURE__*/jsx_runtime.jsx(node.MenuItem, {
                value: "",
                disabled: true,
                children: "Select Type"
              }), Object.entries(serviceNames).map((event, i) => /*#__PURE__*/jsx_runtime.jsx(node.MenuItem, {
                value: event[0],
                children: event[1]
              }, i))]
            })]
...
;// CONCATENATED MODULE: ./src/pages/services/index.tsx
...
const useStyles = (0,styles_node.makeStyles)((0,styles_node.createStyles)({
  filtersActiveLabel: {
    color: '#998',
    fontSize: '14px',
    paddingRight: 10
...
const fetchAllServices = async searchQuery => {
  const response = await config/* ayoojonApi.get */.ZG.get(`services?${generateQueryString(searchQuery)}`);
  return {
...
const Services = ({
  ...
  const {
    ...
    isLoading
  } = (0,lib.useQuery)(['services', debouncedQuery], () => fetchAllServices(debouncedQuery), {
    initialData: {
  ...
  const handleDelete = key => {
    setSearchQuery(pre => {
      return services_objectSpread(services_objectSpread({}, pre), {}, {
        [key]: undefined
      });
    });
  };
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/jsx_runtime.jsx(SEO/* default */.Z, {
    ...
    }), (searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.name) || (searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.serviceType) && /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/jsx_runtime.jsx("span", {
        ...
        variant: "outlined"
      }), (searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.serviceType) && /*#__PURE__*/jsx_runtime.jsx(node.Chip, {
        className: classes.filterChip // key={column.id}
        ,
        label: /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [/*#__PURE__*/jsx_runtime.jsx("span", {
    ...
    }), services && (services === null || services === void 0 ? void 0 : services.length) > 0 ? /*#__PURE__*/jsx_runtime.jsx("div", {
      className: "grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4",
      children: services.map(service => /*#__PURE__*/jsx_runtime.jsx(next_link.default, {
        href: `/services/${service.url}`,
        children: /*#__PURE__*/jsx_runtime.jsx("a", {
          children: /*#__PURE__*/jsx_runtime.jsx(ServiceCard, {
            service: service
          }, service._id)
        })
      }, service._id))
...
/* harmony import */ var next_dist_build_webpack_loaders_next_serverless_loader_page_handler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(99436);
      ...
      const compMod = __webpack_require__(6931)
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [6486,9008,4491,4753,7659,4651,7234,6994,8628,8974,4576,1843,9402], () => (__webpack_require__(60330)))
