...
var index = require('./index-ca32e11d.js');
require('./image-handler-f6c4b901.js');
...
const deserializeAws_restXmlGetObjectCommand = async (output, context) => {
    ...
    if (output.headers["content-length"] !== undefined) {
        contents.ContentLength = index.strictParseInt(output.headers["content-length"]);
    }
    if (output.headers["etag"] !== undefined) {
        contents.ETag = output.headers["etag"];
    }
    if (output.headers["x-amz-missing-meta"] !== undefined) {
        contents.MissingMeta = index.strictParseInt(output.headers["x-amz-missing-meta"]);
    }
    ...
    if (output.headers["x-amz-mp-parts-count"] !== undefined) {
        contents.PartsCount = index.strictParseInt(output.headers["x-amz-mp-parts-count"]);
    }
    if (output.headers["x-amz-tagging-count"] !== undefined) {
        contents.TagCount = index.strictParseInt(output.headers["x-amz-tagging-count"]);
    }
